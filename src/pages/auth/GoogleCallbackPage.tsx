...
import { Chrome, CheckCircle, AlertCircle, Loader2, Home } from 'lucide-react';
    ...
    const handleGoogleCallback = async () => {
      try {
        ...
        if (error) {
          ...
          setErrorMessage(errorDescription || 'Google authentication failed');
          setStatus('error');
          return;
        }
      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
        ...
        <div className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6 ${
          ...
          {status === 'processing' && (
            <div className="relative">
              ...
              <Loader2 className="w-6 h-6 text-red-600 animate-spin absolute -top-1 -right-1" />
            </div>
          )}
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <p className="text-xs text-gray-500">
            ...
            <a href="mailto:support@sitemapai.com" className="text-red-600 hover:text-red-800">
              support team
            </a>
          </p>
        </div>
